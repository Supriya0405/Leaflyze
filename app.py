...
app = FastAPI(title="Leaflyze API - AI Leaf Disease Detection", version="1.0.0", description="AI-powered leaf disease detection and analysis")
...
async def root():
    ...
    return {
        "message": "Leaflyze API - AI Leaf Disease Detection",
        "version": "1.0.0",
